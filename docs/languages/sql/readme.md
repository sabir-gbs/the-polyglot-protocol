# SQL Codegen Decisions

Purpose: Schemas, migrations, queries, views, indexes, and persistence contracts.

Use this README as the human-readable summary for `sql.md`. The full rules live in `../sql.md`.
...
- Use native documentation, validation, and error-handling conventions for SQL.
