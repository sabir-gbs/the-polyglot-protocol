...
Purpose: .NET applications, services, libraries, and Unity code.

Use this README as the human-readable summary for `c-sharp.md`. The full rules live in `../c-sharp.md`.
...
- Use native documentation, validation, and error-handling conventions for C#.
...
- Full language guide: `../c-sharp.md`
