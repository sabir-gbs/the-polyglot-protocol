# JavaScript Codegen Decisions

Purpose: Existing JS projects, browser behavior, and Node runtime code when TypeScript is not used.

Use this README as the human-readable summary for `javascript.md`. The full rules live in `../javascript.md`.
...
- Use native documentation, validation, and error-handling conventions for JavaScript.
...
- Full language guide: `../javascript.md`
