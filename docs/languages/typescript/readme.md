# TypeScript Codegen Decisions

Purpose: Preferred JavaScript-family product code, services, packages, and frontend apps.

Use this README as the human-readable summary for `typescript.md`. The full rules live in `../typescript.md`.
...
- Use native documentation, validation, and error-handling conventions for TypeScript.
...
- Full language guide: `../typescript.md`
