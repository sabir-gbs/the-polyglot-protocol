# Python Codegen Decisions

Purpose: Default operational scripts, automation, CLIs, services, and data workflows.

Use this README as the human-readable summary for `python.md`. The full rules live in `../python.md`.
...
- Use native documentation, validation, and error-handling conventions for Python.
