# Rust Codegen Decisions

Purpose: Systems software, CLIs, services, WebAssembly, and safe performance-critical code.

Use this README as the human-readable summary for `rust.md`. The full rules live in `../rust.md`.
...
- Use native documentation, validation, and error-handling conventions for Rust.
