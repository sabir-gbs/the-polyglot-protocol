# Lua Codegen Decisions

Purpose: Embedded scripting, host plugins, and lightweight runtime extension code.

Use this README as the human-readable summary for `lua.md`. The full rules live in `../lua.md`.
...
- Use native documentation, validation, and error-handling conventions for Lua.
