# HTML Codegen Decisions

Purpose: Semantic document structure and accessible UI foundations.

Use this README as the human-readable summary for `html.md`. The full rules live in `../html.md`.
...
- Use native documentation, validation, and error-handling conventions for HTML.
