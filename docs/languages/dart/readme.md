# Dart Codegen Decisions

Purpose: Dart packages, CLIs, and Flutter applications.

Use this README as the human-readable summary for `dart.md`. The full rules live in `../dart.md`.
...
- Use native documentation, validation, and error-handling conventions for Dart.
