# Bash Codegen Decisions

Purpose: Shell glue and local command orchestration.

Use this README as the human-readable summary for `bash.md`. The full rules live in `../bash.md`.
...
- Use native documentation, validation, and error-handling conventions for Bash.
