# Go Codegen Decisions

Purpose: Services, CLIs, networking tools, and simple concurrent systems.

Use this README as the human-readable summary for `go.md`. The full rules live in `../go.md`.
...
- Use native documentation, validation, and error-handling conventions for Go.
