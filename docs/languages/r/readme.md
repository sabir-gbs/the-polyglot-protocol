...
Purpose: Statistical analysis, reports, reproducible research, and R packages.

Use this README as the human-readable summary for `r.md`. The full rules live in `../r.md`.
...
- Use native documentation, validation, and error-handling conventions for R.
