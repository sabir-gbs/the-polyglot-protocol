# Kotlin Codegen Decisions

Purpose: Android, JVM services, Gradle plugins, and multiplatform code.

Use this README as the human-readable summary for `kotlin.md`. The full rules live in `../kotlin.md`.
...
- Use native documentation, validation, and error-handling conventions for Kotlin.
