# Ruby Codegen Decisions

Purpose: Rails, gems, and Ruby application code.

Use this README as the human-readable summary for `ruby.md`. The full rules live in `../ruby.md`.
...
- Use native documentation, validation, and error-handling conventions for Ruby.
