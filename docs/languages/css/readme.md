# CSS Codegen Decisions

Purpose: Presentation, layout, design systems, and rendering behavior.

Use this README as the human-readable summary for `css.md`. The full rules live in `../css.md`.
...
- Use native documentation, validation, and error-handling conventions for CSS.
