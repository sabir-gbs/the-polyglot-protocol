# Shopify Liquid Codegen Decisions

Purpose: Shopify themes, sections, snippets, and storefront rendering.

Use this README as the human-readable summary for `shopify-liquid.md`. The full rules live in `../shopify-liquid.md`.
...
- Use native documentation, validation, and error-handling conventions for Shopify Liquid.
...
- Full language guide: `../shopify-liquid.md`
