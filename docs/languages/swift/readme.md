# Swift Codegen Decisions

Purpose: iOS, macOS, Apple platform apps, and Swift packages.

Use this README as the human-readable summary for `swift.md`. The full rules live in `../swift.md`.
...
- Use native documentation, validation, and error-handling conventions for Swift.
