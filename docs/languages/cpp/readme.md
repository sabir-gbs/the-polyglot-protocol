...
Purpose: Native systems, performance-sensitive libraries, and engines.

Use this README as the human-readable summary for `cpp.md`. The full rules live in `../cpp.md`.
