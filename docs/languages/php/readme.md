# PHP Codegen Decisions

Purpose: WordPress, Laravel, Symfony, Composer packages, and PHP applications.

Use this README as the human-readable summary for `php.md`. The full rules live in `../php.md`.
...
- Use native documentation, validation, and error-handling conventions for PHP.
