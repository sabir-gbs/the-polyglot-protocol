...
Purpose: Low-level systems, embedded, ABI, and resource-constrained code.

Use this README as the human-readable summary for `c.md`. The full rules live in `../c.md`.
